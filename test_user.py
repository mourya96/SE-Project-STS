...
def test_create_user_student(client):
    # Set up test data
    new_user = {'username': 'testuser', 'password': 'testpassword','email':'testuser@gmail.com','role':'student'}
...
def test_create_user_staff(client):
    # Set up test data
    new_staff = {'username': 'teststaff', 'password': 'testpass','email':'teststaff@gmail.com','role':'staff','subject_id':1}
...
def test_put_user(client):
    email='user1@gmail.com'
    response = client.put(f'/api/login/{email}',json={'password':'user1pass','role':'student'})
